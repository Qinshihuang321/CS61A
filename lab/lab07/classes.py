...
class Player:
    ...
    def play(self, card_index):
        ...
        """
        "*** YOUR CODE HERE ***"
        chosed_card = self.hand.pop(card_index)
        return chosed_card
...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        save = other_card.attack
        other_card.attack = other_card.defense
        other_card.defense = save
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        at = other_card.attack
        de = other_card.defense
        copy = opponent.deck.cards[:]
        for card in player.deck.cards:
            card.attack += at
            card.defense += de
        for card in copy:
            if card.attack == at or card.defense == de:
