...
class Insect:
    ...
    def remove_from(self, place):
        if self.name == 'Queen' and self.is_first:
            pass
        else:
            self.place = None
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.digesting > 0:
            ...
            if self.place.bees:
                if gamestate.time - self.digesting > self.time_to_digest or self.digesting == 0:
        ...
        if self.is_first:
            ...
            if self.is_first:
                ...
                while place is not None:
                    if place.ant and not place.ant.is_double:
